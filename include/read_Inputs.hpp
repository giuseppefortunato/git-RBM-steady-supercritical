...
struct prob_settings 
{
    ...
    std::vector<int> neighbors;                 // vector of k neighbors to try
    int k_rec;                                  // number of neighbors for reconstruction
    int r_isomap;                               //numeber of eigenvectors to use in the manifold
    ...
    std::vector<double> alpha_rec;               //alpha desired for reconstruction in steady case
    std::vector<double> supercritical_rec;                //mach desired for reconstruction in steady case
    std::vector<double> param_rec_1;
    std::vector<double> param_rec_2;
    std::vector<double> param_rec_3;
    std::vector<double> param_rec_4;
    std::vector<double> param_rec_5;
    std::vector<double> param_rec_6;
...
//read coeff for steady simulation POD
